...
if __name__ == '__main__':
	...
	pos_cmd_point.positions[0] = 0.81
	pos_cmd_point.positions[1] = -0.5409
	pos_cmd_point.positions[2] = 1.3434
	pos_cmd_point.positions[3] = -1.838
	pos_cmd_point.positions[4] = -1.5644
	pos_cmd_point.positions[5] = -1.7846
