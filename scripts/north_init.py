...
if __name__ == '__main__':
	...
	pos_cmd_point.positions[0] = 0.8963
	pos_cmd_point.positions[1] = -0.5845
	pos_cmd_point.positions[2] = 1.3554
	pos_cmd_point.positions[3] = -1.8807
	pos_cmd_point.positions[4] = -1.5644
	pos_cmd_point.positions[5] = -1.7726
