...
if __name__ == '__main__':
	...
	pos_cmd_point.positions[0] = 0.8061
	pos_cmd_point.positions[1] = -0.5433
	pos_cmd_point.positions[2] = 1.359
	pos_cmd_point.positions[3] = -1.832
	pos_cmd_point.positions[4] = -1.5644
	pos_cmd_point.positions[5] = -1.769
