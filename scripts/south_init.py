...
if __name__ == '__main__':
	...
	pos_cmd_point.positions[0] = 0.718
	pos_cmd_point.positions[1] = -0.4927
	pos_cmd_point.positions[2] = 1.362
	pos_cmd_point.positions[3] = -1.794
	pos_cmd_point.positions[4] = -1.5644
	pos_cmd_point.positions[5] = -1.7655
